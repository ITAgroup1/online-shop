...
(getList = function () {
    ...
    getData = function (currNum) {
        ...
        $.ajax({
            type: "GET",
            url: "http://localhost:9090/merchantDetail/listVerify",
            data: pageable,
    ...
    getButtun = function (merchantDetailID, status) {
        ...
        a1.on("click", function () {
            updateStatus(merchantDetailID, 1);
        });
        a2.on("click", function () {
            updateStatus(merchantDetailID, 2);
        });
        a3.on("click", function () {
            updateStatus(merchantDetailID, 3);
        });

        a4.on("click", function () {
            toggleC("c" + merchantDetailID);
        });
    ...
    ctreateChild = function (merchantDetail) {
        ...
        div.attr("id", "c" + merchantDetail.id);
        let table = $("<table>");
